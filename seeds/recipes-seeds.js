...
const recipeData = [
  {
    ...
    ingredient_array: ["2 cups all-purpose flour", "1 tbsp salt", "4 tbsp baking powder", "2tbsp white sugar", "2 eggs", "1 1/2 cups of warm milk", "1/3 cup melted butter", "1tbsp vanilla extract"],
    instructions:
  ...
  },
  {
    ...
    ingredient_array: ["4 eggs whites", "2 1/4 cups confectioners' sugar."],
    instructions:
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/d/df/Tarte_au_citron_%281%29.jpg",
    type: "Dessert",
    cuisines: "French",
    serving: 36,
    user_id: 1,
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/f/fe/2_Chapati_warm_and_ready_to_be_eaten.jpg",
    type: "Side",
    cuisines: "African",
    serving: 6,
    user_id: 1,
  },
  {
    ...
    image: "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2011/7/5/0/BX0501H_grilled-pineapple_s4x3.jpg.rend.hgtvcom.616.462.suffix/1371599867318.jpeg",
    type: "Dessert",
    cuisines: "Brazilian",
    serving: 6,
    user_id: 1,
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/6/60/Limonada_su%C3%AD%C3%A7a.jpg",
    type: "Beverage",
    cuisines: "Brazilian",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/3/39/P%C3%A3o_de_Queijo_-_cheese_bread.jpg",
    type: "Side",
    cuisines: "Brazilian",
    serving: 14,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["1 (8 ounce) box elbow macaroni", "1/4 cup of butter", "1/4 cup of all-purpose flour", "1/2tbsp of salt", "ground black pepper to taste", "2 cups of milk", "2 cups of shredded Cheddar cheese."],
    instructions:
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/c/c6/Macaroni_and_Cheese_%284999893839%29.jpg",
    type: "Side",
    cuisines: "American",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["2/3 cup of milk, 2 large eggs, 1tbsp of vanilla extract, 1/4tbsp of ground cinnamon, salt to taste, 6 thick slices of bread", "1tbsp of unsalted butter."],
    instructions:
    ...
    summary: "A delicious morning treat",
    image: "https://upload.wikimedia.org/wikipedia/commons/0/08/French_Toast_%286766484799%29.jpg",
    type: "Breakfast",
    cuisines: "French",
    serving: 3,
    user_id: 1,
  ...
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/6/68/Making_cinder_toffee_%2811279416155%29.jpg",
    type: "Dessert",
    cuisines: "British",
    serving: 15,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["1 (8 ounce) package of uncooked spaghetti", "1 1/2tbsp of olive oil", "1 cup of chopped sweet onions", "3 chopped green onions", "2tbsp of prepared basil pesto", "2 (6 ounce) cans of drained flaked salmon", "1/2 cup of Parmesan Cheese"],
    instructions:
  ...
  },
  {
    ...
    image: "https://assets.simpleviewinc.com/simpleview/image/upload/c_fill,g_xy_center,h_1283,q_75,w_1920,x_1695,y_2305/v1/clients/newmexico/60_JosiesMerriam38_277e7bc5-fea9-44ab-bb49-ccc565567dbb.jpg",
    type: "Dessert",
    cuisines: "Mexican",
    serving: 6,
    user_id: 1,
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/4/4f/Chicken_breast_on_Spinach.jpg",
    type: "Dinner",
    cuisines: "Italian",
    serving: 6,
    user_id: 1,
  },
  {
    ...
    image: "https://c.pxhere.com/photos/f2/0b/bbq_ribs_ribs_meat_sauce_table_wood_french_fries_salad-518880.jpg!d",
    type: "Dinner",
    cuisines: "Chinese",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["4 eggs", "1 quart of buttermilk", "1 pound of peeled and shredded beets", "1 large English peeled and slice cucumber", "1/4 cup of minced chives", "1 bunch of fresh minced dill."],
    instructions:
    ...
    summary: "A delicious morning treat",
    image: "https://upload.wikimedia.org/wikipedia/commons/8/87/%C5%A0altibar%C5%A1%C4%8Diai_Lithuanian_Cold_Beet_Soup.jpg",
    type: "Breakfast",
    cuisines: "Lithuanian",
    serving: 8,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["1 cup of olive oil", "1/4 cup of soy sauce", "1 lemon juice", "3 gloves of minced garlic", "3tbsp of minced fresh ginger root", "1tbsp of prepared Dijon-style mustard", "2tbsp of honey", "ground black pepper to taste."],
    instructions:
    ...
    summary: "A delicious morning treat",
    image: "https://upload.wikimedia.org/wikipedia/commons/7/71/Chinese_Seitan_Salad_with_Ginger_Miso_Dressing_%284585441961%29.jpg",
    type: "Breakfast",
    cuisines: "Japanese",
    serving: 12,
    user_id: 1,
  },
  {
    ...
    ingredient_array:
      ["2 medium cucumbers", "6tbsp of rice wine vinegar", "6tbsp of white sugar", "2tbsp of soy sauce", "1/2tbsp of sesame seeds."],
    instructions:
    ...
    summary: "A delicious morning treat",
    image: "https://upload.wikimedia.org/wikipedia/commons/7/78/Cucumber_salad_green_onions_dill.jpg",
    type: "Breakfast",
    cuisines: "Japanese",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    image: "https://betterbegrilled.com/wp-content/uploads/2017/01/20161231_194650-5-520x520.jpg",
    type: "Dinner",
    cuisines: "American",
    serving: 10,
    user_id: 1,
  },
  {
    ...
    image: "https://www.skinnytaste.com/wp-content/uploads/2011/10/pollo-in-potacchio-1-5.jpg",
    type: "Dinner",
    cuisines: "Italian",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    image: "https://jamiegeller.com/.image/ar_4:3%2Cc_fill%2Ccs_srgb%2Cq_auto:good%2Cw_1200/MTY1NTI0Nzk4NzY3NzY4NjAz/fish-tacos.png",
    type: "Dinner",
    cuisines: "Hawaiian",
    serving: 4,
    user_id: 1,
  },
  {
    ...
    image: "https://upload.wikimedia.org/wikipedia/commons/4/49/Chicken_wrapped_in_prosciutto._%28335163752%29.jpg",
    type: "Dinner",
    cuisines: "Italian",
    serving: 2,
    user_id: 1,
